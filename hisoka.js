...
Saya 𝘽𝙤𝙩 𝙒𝙝𝙖𝙩𝙨𝙖𝙥𝙥 Yang Di Buat Oleh 𝙁𝙞𝙠𝙧𝙞𝙞𝙎𝙠𝙮
...
⭔ Url : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
            ...
            break
            case 'anime': case 'waifu': case 'husbu': case 'neko': case 'shinobu': case 'megumin': case 'uniform': case 'maid': {
                m.reply(mess.wait)
            ...
            case 'waifus': case 'nekos': case 'trap': case 'blowjob': {
                m.reply(mess.wait)
                hisoka.sendMessage(m.chat, { image: { url: api('zenz', '/api/random/'+command, {}, 'apikey') }, caption: 'tch Dasar Sangne🤤 Nih ' + command }, { quoted: m })
            }
            break
	    case 'couple': {
                m.reply(mess.wait)
		...
		let { quotesAnime } = require('./lib/scraper')
            ...
            break
	        case 'motivasi': case 'dilanquote': case 'bucinquote': case 'puisi': case 'katasenja': {
